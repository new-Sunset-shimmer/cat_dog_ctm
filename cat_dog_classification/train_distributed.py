...
from tasks.cat_dog_classification.train import get_dataset # Use shared get_dataset
...
from tasks.cat_dog_classification.plotting import plot_neural_dynamics, make_classification_gif
...
def parse_args():
    ...
    parser.add_argument('--memory_length', type=int, default=50, help='Length of the pre-activation history for NLMS (CTM only).')
